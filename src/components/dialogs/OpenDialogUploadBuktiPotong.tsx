...
type OpenDialogUploadBuktiPotongProps = {
...
const OpenDialogUploadBuktiPotong = (props: OpenDialogUploadBuktiPotongProps) => {
    // Props
...
export default OpenDialogUploadBuktiPotong

...
const OpenDialogEditUser = (props: OpenDialogEditUserProps) => {
  // Props
  ...
  return (
    <>
      ...
      <Element onClick={handleOnClick} {...restElementProps} className="bg-warning" />
...
export default OpenDialogEditUser

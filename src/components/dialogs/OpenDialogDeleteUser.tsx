...
type OpenDialogDeleteUserProps = {
...
const OpenDialogDeleteUser = (props: OpenDialogDeleteUserProps) => {
    // Props
    ...
    return (
        <>
            ...
            <Element onClick={handleOnClick} {...restElementProps} className="bg-red-600" />
...
export default OpenDialogDeleteUser
